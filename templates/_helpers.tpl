...
We truncate at 44 chars because some Kubernetes name fields are limited to 63 chars (by the DNS naming spec).
We chose 44 instead of 63 because some resource names have suffixes
